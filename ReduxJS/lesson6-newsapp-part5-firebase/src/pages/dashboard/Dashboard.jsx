...
import { removeNewsFromDatabase } from '../../tools/actions/newsActions';
                            ...
                            <tbody>
                                {data.map((item, c) => (
                                    <tr>
                                        ...
                                        <td><button onClick={() => { dispatch(removeNewsFromDatabase(item.id)) }} className='btn btn-danger'>Del</button></td>
                                    </tr>
                                ))}
                            </tbody>
                        }
